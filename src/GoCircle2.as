...
package
{
	 ...
	 */
	public class GoCircle2 extends UIComponent
	{
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void {
			...
			graphics.clear();
		//	graphics.beginGradientFill(GradientType.LINEAR, [0xFF0000, 0xFF0000], [.1, .5], [0, 127], 
			//	null, SpreadMethod.PAD, InterpolationMethod.RGB, 0.75);
			graphics.lineStyle(2,0xFF0000);
			graphics.drawCircle(unscaledWidth / 2, unscaledHeight / 2, unscaledHeight / 1.9);
