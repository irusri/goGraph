package 
{
	...
	public class AlertTimer
	{
		...
		public var backgroundColor:String="#FF0000";
	...
	//	private var tmpCircle:GoNodeCircle=new GoNodeCircle();
		...
		//	myWin.title = alertTitle;
			...
			myWin.setStyle('cornerRadius',50);
			myWin.setStyle('backgroundAlpha',.7);
			this.createChildren();
